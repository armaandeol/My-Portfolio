...
type ProjectDocumentDataSlicesSlice = RichTextSlice | ImageBlockSlice | ContentindexSlice;
...
interface SettingsDocumentData {
	 ...
	 * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
	 */
	github_link: prismic.Repeatable<
...
export interface HeroSliceDefaultPrimary {
	 ...
	 * - **Field Type**: Text
	 * - **Placeholder**: *None*
	 * - **API ID Path**: hero.default.primary.firstt_name
	 * - **Documentation**: https://prismic.io/docs/field#key-text
	 */
